...
# --- CONEXÃO (USE SEU LINK /EXEC MAIS RECENTE) ---
WEBAPP_URL = "https://script.google.com/macros/s/AKfycbzWJ_nDGDe4a81O5BDx3meMbVJjlcMpJoxoO05lilysWJaj_udqeXqvfYFgzvWPlC-Omw/exec"
CSV_URL = "https://docs.google.com/spreadsheets/d/1jrtIP1lN644dPqY0HPGGwPWQGyYwb8nWsUigVK3QZio/export?format=csv"

# --- FUNÇÕES DE LIMPEZA E MÁSCARAS ---
                ...
                with st.expander(label):
                    ...
                    with c2:
                        ...
                        if rua and num:
                            ...
                            endereco_texto = f"{rua}, {num}, {bairro}, Brazil, {cep}"
                            link_maps = f"https://www.google.com/maps/search/?api=1&query={quote(endereco_texto)}"
                            st.link_button("📍 Abrir no Google Maps", link_maps)
                        else:
                            st.write("🏠 Endereço não cadastrado.")
        ...
        with st.form("form_novo", clear_on_submit=True):
            ...
            if st.form_submit_button("SALVAR NA NUVEM"):
                if f_nome:
                    ...
                    st.success("✅ Salvo na Planilha e na Agenda!")
                    st.rerun()

    # --- ABA 3: EDIÇÃO ---
    with tab3 = t3: # Ajuste de variável
        if lista_nomes:
            ...
            with st.form("form_edit"):
                ...
                if st.form_submit_button("ATUALIZAR"):
                    up = [sel, e_dt, p.get('ascendente',''), e_tel, p.get('email',''), e_ru, e_nu, p.get('comp',''), p.get('bairro',''), p.get('cep','')]
