...
# 2. BLINDAGEM E LIBERAÇÃO DO NAVEGADOR (RESPIRO PARA OS 3 PONTINHOS)
st.markdown("""
    <style>
    ...
    /* Libera o cabeçalho para o menu lateral funcionar */
    header[data-testid="stHeader"] {
        background-color: rgba(255, 255, 255, 0) !important;
    }
    
    /* Aumenta o topo para o Chrome não esconder a barra de ferramentas */
